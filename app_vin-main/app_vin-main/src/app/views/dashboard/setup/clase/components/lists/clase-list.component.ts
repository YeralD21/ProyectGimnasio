        ...
        <div class="w-full mx-auto p-6 bg-white rounded overflow-hidden shadow-lg">
            <div class="flex justify-between items-center mb-2 bg-slate-300 text-black p-4 rounded">
                <h2 class="text-2xl font-bold">
                    Lista de <span class="text-primary">Clases</span>
                </h2>
                <button mat-flat-button color="primary" (click)="goNew()">
                    <mat-icon>add</mat-icon>
                    <span class="ml-2">Nueva Clase</span>
                </button>
            </div>
                ...
                <div class="p-2 overflow-scroll px-0">
                    <table class="w-full table-fixed">
                        ...
                        <tr>
                            ...
                            <th class="w-2/6 text-center px-5 border-r">Tipo</th>
                            <th class="w-2/6 text-center px-5 border-r">Hora</th>
                            <th class="w-2/6 text-center px-5 border-r">Costo</th>
                            <th class="w-2/6 text-center px-5 border-r">Cupos Disponibles</th>
                            <th class="w-2/6 text-center px-5 border-r">Instructor</th>
                            <th class="w-2/6 text-center">Acciones</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr *ngFor="let clase of clases; let i = index" class="hover:bg-gray-100">
                            <td class="w-1/6 p-2 text-center border-b">{{ i + 1 }}</td>
                            <td class="w-2/6 p-2 text-start border-b text-sm">{{ clase.tipo }}</td>
                            ...
                            <td class="w-2/6 p-2 text-center border-b text-sm">
                                <div class="flex justify-center space-x-3">
                                    ...
                                    <mat-icon class="text-rose-500 hover:text-rose-600 cursor-pointer" (click)="goDelete(clase.id)">delete_sweep</mat-icon>
                                </div>
                            </td>
                        </tr>
                        </tbody>
